  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">View and respond to vaccination campaigns at school</p>
      </div>
      ...
      {filteredCampaigns.length > 0 ? (
              ...
              <div className="px-6 py-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900">{campaign.vaccine}</p>
                  </div>
                  <div>
                ...
                {(campaign.status === 'Active' || campaign.status === 'Completed') && (
                  <div className="mt-6">
                    <div className="flex justify-between items-center mb-1">
                      <h3 className="text-sm font-medium text-gray-700">Vaccination Progress</h3>
                      <span className="text-sm font-medium text-gray-700">
                        {campaign.vaccinationsCompleted} of {campaign.totalStudents} ({Math.round(campaign.vaccinationsCompleted/campaign.totalStudents*100)}%)
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div 
                        className="bg-green-600 h-2.5 rounded-full" 
                        style={{ width: `${Math.round(campaign.vaccinationsCompleted/campaign.totalStudents*100)}%` }}
                      ></div>
                    </div>
        ...
        <div className="bg-white rounded-lg shadow p-8 text-center">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">No vaccination campaigns found</h3>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              Vaccination campaigns help protect our school community. Please submit consent forms by the deadline to ensure your child can participate.
            </p>
          </div>
        </div>
      </div>
