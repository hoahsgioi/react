...
function VaccinationConsentForm() {
  ...
  const [consentForm, setConsentForm] = useState({
    ...
    currentMedications: students[0].medicalHistory.currentMedications.join(', '),
  ...
  const handleSubmit = (e) => {
    ...
    alert(`Consent form ${consentForm.consent ? 'approved' : 'declined'} for ${activeStudent.name}`);
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-blue-50 rounded-lg p-6 mb-8 border border-blue-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <p className="text-sm font-medium text-gray-500">Consent Deadline</p>
            <p className="font-medium">
              {formatDate(campaign.consentDeadline)}
              {isDeadlinePassed() && <span className="text-red-600 ml-2">(Passed)</span>}
            </p>
          </div>
        </div>
        <div className="mt-4">
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        {isDeadlinePassed() ? (
          <div className="p-8 text-center">
            ...
            <h3 className="mt-2 text-lg font-medium text-gray-900">Consent Deadline Has Passed</h3>
            <p className="mt-1 text-gray-500">
              The deadline for submitting the consent form was {formatDate(campaign.consentDeadline)}.
              Please contact the school nurse if you still wish to give consent.
            </p>
          </div>
        ) : (
          <form onSubmit={handleSubmit}>
            <div className="p-6 border-b">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">{activeStudent.grade} | {activeStudent.age} years old</p>
                </div>
                {activeStudent.hasConsent !== null && (
                  <div className={`px-4 py-1 rounded-full text-sm font-medium ${
                    ...
                    {activeStudent.hasConsent ? 'Consent Given' : 'Consent Declined'}
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="p-6">
              {/* Vaccine Information */}
              <div className="mb-8">
                <h3 className="text-lg font-medium mb-4 border-b pb-2">Vaccine Information</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Formulation</p>
                  ...
                  <div className="col-span-2">
                    <p className="text-sm font-medium text-gray-500">Administration Route</p>
              ...
              {/* Medical History */}
              <div className="mb-8">
                <h3 className="text-lg font-medium mb-4 border-b pb-2">Medical History</h3>
                ...
                <div className="mb-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      <label htmlFor="previousReactions" className="font-medium text-gray-700">
                        Has the student had a previous adverse reaction to any vaccination?
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      <label htmlFor="hadVaccineBefore" className="font-medium text-gray-700">
                ...
                <div className="mb-4">
                  <div className="flex items-start mb-1">
                    ...
                    <div className="ml-3 text-sm">
                      <label htmlFor="recentIllness" className="font-medium text-gray-700">
              ...
              {/* Consent Decision */}
              <div className="mb-8">
                <h3 className="text-lg font-medium mb-4 border-b pb-2">Consent Decision</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    <input
                      ...
                      onChange={() => setConsentForm(prev => ({...prev, consent: true}))}
                    />
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      onChange={() => setConsentForm(prev => ({...prev, consent: false}))}
                    />
              ...
              <div className="mb-8">
                <h3 className="text-lg font-medium mb-4 border-b pb-2">Parent/Guardian Information</h3>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="parentName">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="relationshipToStudent">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      <label htmlFor="agreeToTerms" className="font-medium text-gray-700">
                        I affirm that I am the parent/legal guardian of the above-named student. I have read or had explained to me the information provided about the vaccine. I have had a chance to ask questions which were answered to my satisfaction. I understand the benefits and risks of the vaccination and I request that the vaccine be given to the student named above for whom I am authorized to make this request.
                      </label>
                    </div>
                  </div>
                </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-yellow-700">
              Your consent decision is important. Please complete this form by {formatDate(campaign.consentDeadline)}. If you have questions about this vaccine, please contact the school nurse.
            </p>
          </div>
        </div>
      </div>
