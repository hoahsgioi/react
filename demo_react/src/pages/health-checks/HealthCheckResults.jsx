...
function HealthCheckResults() {
  ...
  const [students, setStudents] = useState([
    {
      ...
      results: {
        ...
        followUpNeeded: true,
        followUpReason: 'Slight vision concern in right eye, recheck in 6 months'
      }
    },
    {
      id: 2,
      ...
      results: {
        vision: {
          ...
          rightEye: '20/40',
          colorVision: 'Normal',
          notes: 'Vision below normal range. Referral for optometrist evaluation recommended.',
        ...
        bmiCategory: 'Normal weight',
        followUpNeeded: true,
        followUpReason: 'Vision and hearing concerns require follow-up with specialists'
      }
    },
    {
      id: 3,
  ...
  const stats = {
    ...
    visionIssues: students.filter(s => 
    ...
    hearingIssues: students.filter(s => 
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Review your child's health screening results</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <div className="text-sm font-medium text-gray-500">Students Screened</div>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <div className="text-sm font-medium text-gray-500">Passed All Screenings</div>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <div className="text-sm font-medium text-gray-500">Need Follow-up</div>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <div className="text-sm font-medium text-gray-500">Vision Issues</div>
                ...
                <div className="ml-4 flex-1">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{student.grade} | {student.age} years</p>
                    </div>
          ...
          {selectedStudent ? (
            <div>
              <div className="p-6 border-b">
                ...
                <p className="text-gray-500">{selectedStudent.grade} | Class {selectedStudent.class} | {selectedStudent.age} years old</p>
              </div>
              ...
              <div className="border-b">
                <nav className="flex">
                  ...
                  <button 
                    className={`py-4 px-6 font-medium text-sm focus:outline-none ${
                      activeTab === 'vision' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500 hover:text-gray-700'
                    }`}
                  ...
                  <button 
                    className={`py-4 px-6 font-medium text-sm focus:outline-none ${
                      activeTab === 'hearing' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500 hover:text-gray-700'
                    }`}
                  ...
                  <button 
                    className={`py-4 px-6 font-medium text-sm focus:outline-none ${
                      activeTab === 'growth' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500 hover:text-gray-700'
                    }`}
              ...
              <div className="p-6">
                  ...
                  <div>
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <p className="text-sm font-medium text-gray-500">Vision Status</p>
                          <p>
                            <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
                              getStatusBadgeStyle(selectedStudent.results.vision.status)
                            }`}>
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-500">Hearing Status</p>
                          <p>
                            <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
                              getStatusBadgeStyle(selectedStudent.results.hearing.status)
                            }`}>
                        ...
                        <div>
                          ...
                          <p>{selectedStudent.results.followUpNeeded ? 'Yes' : 'No'}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    {selectedStudent.results.followUpNeeded && (
                      <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-md">
                        <div className="flex">
                          ...
                          <div className="ml-3">
                            <h3 className="text-sm font-medium text-red-800">Follow-up Recommended</h3>
                ...
                {activeTab === 'vision' && (
                  <div>
                    <div className="mb-6">
                      <h3 className="text-lg font-medium mb-4">Vision Results</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-gray-50 p-4 rounded">
                          <p className="font-medium mb-2">Left Eye</p>
                          <p className="text-2xl">{selectedStudent.results.vision.leftEye}</p>
                        </div>
                        <div className="bg-gray-50 p-4 rounded">
                          <p className="font-medium mb-2">Right Eye</p>
                          <p className="text-2xl">{selectedStudent.results.vision.rightEye}</p>
                        </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded mb-4">
                      ...
                      <p>{selectedStudent.results.vision.notes || 'No additional notes'}</p>
                    </div>
                    
                    <div className="mt-4">
                      <p className="text-sm text-gray-500 mb-1">Vision Status</p>
                      <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
                        getStatusBadgeStyle(selectedStudent.results.vision.status)
                      }`}>
                        {selectedStudent.results.vision.status}
                ...
                {activeTab === 'hearing' && (
                  <div>
                    <div className="mb-6">
                      <h3 className="text-lg font-medium mb-4">Hearing Results</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-gray-50 p-4 rounded">
                          <p className="font-medium mb-2">Left Ear</p>
                          <p className="text-2xl">{selectedStudent.results.hearing.leftEar}</p>
                        </div>
                        <div className="bg-gray-50 p-4 rounded">
                          <p className="font-medium mb-2">Right Ear</p>
                          <p className="text-2xl">{selectedStudent.results.hearing.rightEar}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded mb-4">
                      <p className="font-medium mb-2">Notes</p>
                      <p>{selectedStudent.results.hearing.notes || 'No additional notes'}</p>
                    </div>
                    
                    <div className="mt-4">
                      <p className="text-sm text-gray-500 mb-1">Hearing Status</p>
                      <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
                        getStatusBadgeStyle(selectedStudent.results.hearing.status)
                      }`}>
                        {selectedStudent.results.hearing.status}
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-gray-50 p-4 rounded">
                          ...
                          <p className="text-2xl">{selectedStudent.results.height} cm</p>
                        </div>
                        <div className="bg-gray-50 p-4 rounded">
                          <p className="font-medium mb-2">Weight</p>
                          <p className="text-2xl">{selectedStudent.results.weight} kg</p>
                        </div>
                        <div className="bg-gray-50 p-4 rounded">
                          <p className="font-medium mb-2">BMI</p>
                          <p className="text-2xl">{selectedStudent.results.bmi}</p>
                          <p className="text-sm mt-1">{selectedStudent.results.bmiCategory}</p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="flex items-center justify-center h-full p-10">
              <div className="text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Choose a student from the list to view their health check results
                </p>
              </div>
            </div>
          )}
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              If you have any questions about these results or need to schedule a follow-up appointment, please contact the school nurse at nurse@school.edu or call (555) 123-4567.
            </p>
          </div>
        </div>
      </div>
