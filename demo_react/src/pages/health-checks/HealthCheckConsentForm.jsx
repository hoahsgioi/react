    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Please review and submit this consent form for the upcoming health check</p>
        </div>
        <Link 
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-8">
        ...
        <div className="mt-4">
          <p className="text-sm font-medium text-gray-500 mb-2">Procedures Included</p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-lg font-bold mb-4">Select Children for Health Check</h2>
          <p className="mb-4 text-gray-600">Please select the children you want to consent for this health check.</p>
          
          <div className="space-y-4">
            {students.map(student => (
              <div key={student.id} className="flex items-center p-4 border rounded hover:bg-gray-50">
                <input
                ...
                />
                <label htmlFor={`student-${student.id}`} className="ml-3 flex flex-col cursor-pointer">
                  <span className="text-gray-900 font-medium">{student.name}</span>
                  <span className="text-gray-500 text-sm">{student.grade} | {student.gender} | DOB: {student.dateOfBirth}</span>
                </label>
              </div>
            ))}
          </div>
        ...
        {/* Medical Information */}
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-lg font-bold mb-4">Relevant Medical Information</h2>
          <p className="mb-4 text-gray-600">Please provide any relevant medical information that may be important for the health check.</p>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="previousScreeningIssues">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-lg font-bold mb-4">Upload Medical Documents (Optional)</h2>
          <p className="mb-4 text-gray-600">You can upload any relevant medical documents for your child(ren) that may assist in the health check.</p>
          ...
          <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
            <div className="space-y-1 text-center">
              ...
              <div className="flex text-sm text-gray-600">
                <label htmlFor="documentUpload" className="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                  ...
                  <li key={index} className="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                    <div className="w-0 flex-1 flex items-center">
                      <svg className="flex-shrink-0 h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M8 4a3 3 0 00-3 3v4a5 5 0 0010 0V7a1 1 0 112 0v4a7 7 0 11-14 0V7a5 5 0 0110 0v4a3 3 0 11-6 0V7a1 1 0 002 0v4a1 1 0 102 0V7a3 3 0 00-3-3z" clipRule="evenodd" />
                      </svg>
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="consentToScreening" className="font-medium text-gray-700">
                  I consent for my child(ren) to participate in the health screening
                </label>
                <p className="text-gray-500">
                  I understand that this screening includes vision, hearing, and other tests as specified above.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="consentToTreatment" className="font-medium text-gray-700">
                  I consent for first aid or emergency treatment if needed
                </label>
                <p className="text-gray-500">
                  I authorize the school nurse to provide first aid or emergency treatment if necessary during the screening.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="consentToShareResults" className="font-medium text-gray-700">
                  I consent for results to be shared with relevant school staff
                </label>
                <p className="text-gray-500">
                  I authorize the school to share the screening results with teachers and staff as needed for my child's educational support.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              If you have any questions about this health check, please contact the school nurse at nurse@school.edu or call (555) 123-4567.
            </p>
          </div>
        </div>
      </div>
