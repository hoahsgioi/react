      ...
      <div className="container mx-auto px-6 py-4">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4">
            <a href="#home" className="block py-2 px-4 hover:bg-gray-100">Home</a>
            ...
            <a href="#doctors" className="block py-2 px-4 hover:bg-gray-100">Doctors</a>
            <a href="#testimonials" className="block py-2 px-4 hover:bg-gray-100">Testimonials</a>
            <a href="#contact" className="block py-2 px-4 hover:bg-gray-100">Contact</a>
            <Link to="/login" className="block py-2 px-4 text-blue-600 hover:bg-gray-100">
              Login
            </Link>
          </div>
        )}
