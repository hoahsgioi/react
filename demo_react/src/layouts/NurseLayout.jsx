...
function NurseLayout({ children }) {  const { currentUser, logout } = useAuth();
  ...
  return (
    <div className="nurse-layout">      <div className="sidebar bg-info text-white">
        ...
        <nav className="nav flex-column p-2">
          ...
          <a className="nav-link text-white d-flex align-items-center py-2" href="/nurse">
            <i className="bi bi-speedometer2 me-2"></i> Dashboard
          </a>
          
          <div className="nav-category py-2 text-uppercase text-white-50 small fw-bold ps-3">Medical Services</div>
          <a className="nav-link text-white d-flex align-items-center py-2" href="/nurse/events">
            <i className="bi bi-journal-medical me-2"></i> Medical Events
          </a>
          <a className="nav-link text-white d-flex align-items-center py-2" href="/nurse/events/new">
            <i className="bi bi-plus-circle me-2"></i> New Event
          </a>
          <a className="nav-link text-white d-flex align-items-center py-2" href="/nurse/medications">
            <i className="bi bi-capsule me-2"></i> Medications
          </a>
          <a className="nav-link text-white d-flex align-items-center py-2" href="/nurse/medications/admin">
            <i className="bi bi-clipboard2-pulse me-2"></i> Med Administration
          </a>
          <a className="nav-link text-white d-flex align-items-center py-2" href="/nurse/medications/inventory">
          ...
          <a className="nav-link text-white d-flex align-items-center py-2" href="/nurse/vaccinations">
            <i className="bi bi-shield-plus me-2"></i> Vaccination Programs
          </a>
          <a className="nav-link text-white d-flex align-items-center py-2" href="/nurse/health-checks">
            <i className="bi bi-heart-pulse me-2"></i> Health Checkups
          </a>
          
          <div className="nav-category py-2 text-uppercase text-white-50 small fw-bold ps-3">Records</div>
          <a className="nav-link text-white d-flex align-items-center py-2" href="/nurse/students">
