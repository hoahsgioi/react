...
export function AuthProvider({ children }) {
  ...
  const login = async (email, password) => {
    ...
    const mockUsers = [
      ...
      { id: 2, email: 'manager@school.edu', password: 'manager123', name: 'Manager User', role: 'manager' },
      { id: 3, email: 'nurse@school.edu', password: 'nurse123', name: 'School Nurse', role: 'nurse' },
      { id: 4, email: 'parent@example.com', password: 'parent123', name: 'Parent User', role: 'parent' },
      { id: 5, email: 'student@school.edu', password: 'student123', name: 'Student User', role: 'student' },
    ];
